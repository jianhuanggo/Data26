...
if __name__ == '__main__':
    ...
    test = Views()
    print(isinstance(test, scrapy.Spider))
    exit(0)


    process.crawl(Views("test",
                    "PGGG",
                    "/Users/jianhuang/opt/anaconda3/envs/Data20/Data20/WebScraping/test1.yml",
                    False
                    )
              )
    process.start()
