...
def create_session(object_type, subscription_level: int = 1, logger=None):
    ...
    action = {"ner":            {'1': pgner.PGLearningNER,
                                 '2': pgner.PGLearningNERExt,
                                 '999': pgner.PGLearningNERSingleton,
                                },

              'dp':        {'1': pggenericfunc.notimplemented,
                                  '2': pggenericfunc.notimplemented,
                                  '999': pggenericfunc.notimplemented,
                                 },
              'lstm':             {'1': pggenericfunc.notimplemented,
                                     '2': pggenericfunc.notimplemented,
                                     '999': pggenericfunc.notimplemented,
...
def pg_learning(object_type: str, object_name: str, variable_name: str ="_pg_action", subscription_level: int = 1) -> Callable[[F], F]:
