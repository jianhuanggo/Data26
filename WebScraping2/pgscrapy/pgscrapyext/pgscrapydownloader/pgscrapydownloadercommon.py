...
class PGWebScrapingDownloaderCommon(pgclassdefault.PGClassDefault):
    ...
    def _json_dump(self, data: Any, filepath: AnyStr) -> bool:
    ...
    @pgoperation.pg_retry(2)
    def _df_dump(self, data: pd.DataFrame, filepath: AnyStr) -> bool:
    ...
    @pgoperation.pg_retry(2)
    def _joblib_load(self, filepath: AnyStr, reserved: AnyStr = None) -> Any:
    ...
    #@pgoperation.pg_retry(2)
    def _json_load(self, filepath: AnyStr) -> Union[Any, None]:
    ...
    @pgoperation.pg_retry(2)
    def _df_load(self, filepath: AnyStr, reserved: AnyStr = None) -> Union[Dict, None]:
